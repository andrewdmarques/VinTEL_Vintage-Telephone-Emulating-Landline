...
time_of_inactivity = 5/60                 # Time (minutes) that the system would have to wait without detecting motion before there is a chance of an incoming call with newly detected motion.
probability_of_incoming_call = 3/3    # Probability (0-1) that the newly detected motion prompts an incoming call. Values of 1 would result in a call every time there is newly detected motion.
